...
namespace UnityEngine.EventSystems
{
    ...
    public class CustomInputModule : PointerInputModule
    {
        ...
        [SerializeField]
        private float m_RepeatDelay = 0.2f;
        ...
        protected bool SendSubmitEventToSelectedObject()
        {
            ...
            if (input.GetButtonDown(m_SubmitButton) || (Input.GetKeyDown(KeyCode.Mouse0) && !Settings.instance.cursorOn) ||
                (InputManager.instance && (Input.GetKeyDown(InputManager.instance.kKeys.action) ||
                InputManager.instance.GetJoyButtonDown("A"))))
                ExecuteEvents.Execute(eventSystem.currentSelectedGameObject, data, ExecuteEvents.submitHandler);

            if (input.GetButtonDown(m_CancelButton) || (InputManager.instance && (Input.GetKeyDown(InputManager.instance.kKeys.sprint) ||
        ...
        {
            Vector2 move = (InputManager.instance.mode == global::InputMode.keyboard) ? InputManager.instance.UiMovementWithMouse() : InputManager.instance.JoystickMove();
        ...
        protected bool SendMoveEventToSelectedObject()
        {
            ...
            if (axisEventData.moveDir != MoveDirection.None)
            {
                ...
                if (EventSystem.current.currentSelectedGameObject && EventSystem.current.currentSelectedGameObject != obj)
                {
